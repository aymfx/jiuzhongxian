	...
	$(".regist input").on('change', function() {
		...
		if(str != "") {
			if(fn1.shouji(str)) {
				...
				$("#tishi1").stop(true,true).animate({ "opacity": 1 }, 500, function() {
					$("#tishi1").stop(true,true).animate({ opacity: 0 }, 500);
				})
				flag1 = true;
				phone = str;
			} else {
